module.exports = forgotTemp => {
  return `<!DOCTYPE html>
    ...
    <body>
     ...
     background-color: #fffff; height: 100%; margin: 0; padding: 0; width: 100%">
            <center>
     ...
     100%; background-color: #4050fa; height: 100%; margin: 0; padding: 0; width:
     100%" width="100%">
                    <tr>
     ...
     height: 100%; margin: 0; padding: 0; width: 100%; background-color: #fff;" valign="top">
                            <!-- BEGIN TEMPLATE // -->
                            <!--[if gte mso 9]>
     ...
     -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #fffff;
     ...
     padding-bottom: 9px; padding-left: 18px; text-align: center;' valign="top">
                                                                        <a href="#" style="mso-line-height-rule: exactly;
     -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
     font-weight: normal; text-decoration: none" target="_blank" title="reset your password">
                                                                            <img align="center" alt="jeffery" src="http://52.7.244.188:3000/assets/images/LoginLogo.png" style="
     -ms-interpolation-mode: bicubic;
     width: 50%; aspect-ratio: 2/1;object-fit: contain;
     " />
                                                                        </a>
                                                                    </td>
                                                                </tr>
     ...
     -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #d0006e;
     ...
     -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%" valign="top">
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="border-collapse: collapse; mso-table-lspace: 0;
     mso-table-rspace: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust:
     100%; min-width:100%;background-color: #d0006e;" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="mcnTextContent" style='mso-line-height-rule: exactly;
     -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
     ...
     padding: 0'><span style="text-transform:uppercase;color: #F2EADF;">Forgot</span></h1>
     ...
     padding: 0'><span style="text-transform:uppercase;color: #F2EADF">your password?</span></h2>
     ...
     color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
     line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
     padding-bottom: 9px; padding-left: 18px;background-color: #d0006e;color: #F2EADF;' valign="top">Not to worry, we got you! Let’s get you a new password.
                                                                        <br></br>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
     ...
     padding-top:18px; padding-right:18px; padding-bottom:18px; padding-left:18px;background-color: #d0006e;" valign="top">
     ...
     padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top">
                                                                        ...
                                                                        padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                                                                        <a class="mcnButton " href=${forgotTemp.url} style="mso-line-height-rule: exactly;
                                                                        ...
                                                                        #FFFFFF; text-transform:uppercase;color: #000000;">Reset password</a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
     ...
     0; text-align: left; width: 100%; font-size: 16px; font-weight: bold; '>What is Lingo?</h3>
     ...
     text-align: left; text-align: left; font-size: 14px; '>MY TELE MD.
                                                                    </p>
